...
public class CoffeeShop {
	...
	private static Coffee[] coffees = { 
			...
			new Coffee("초코라떼", 4500) 
			};

	public static void main(String[] args) {
		Scanner scanner = new Scanner(System.in);
		System.out.println("고객 이름을 입력 하세요");
		String name  = scanner.nextLine();
		System.out.println("고객 잔액을 입력 하세요");
		...
		//어떤 커피를 선택하였는지 알수 있는 코드를 적성 해보면
		Coffee coffee = coffees[orderNumber-1];
		//고객이 커피를 사다
		customer.buyCoffee(coffee);
		System.out.println(customer.getBalance()+"원 남으셨습니다");//잔액 확인
