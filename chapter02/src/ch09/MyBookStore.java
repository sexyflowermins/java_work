...
//선택 조회하기
	...
	public static int save(Scanner sc,Book[] books,int lastindexNumber) {
		System.out.println("저장하기");
        System.out.println("책제목을 입력하세요");
        String booksTitle = sc.nextLine();
        System.out.println("저자이름을 입력하세요");
        String booksAuthor = sc.nextLine();
        Book book = new Book(booksTitle, booksAuthor);
        books[lastindexNumber] = book;
        lastindexNumber++;
        System.out.println(booksTitle + "책을 저장했어요~");
